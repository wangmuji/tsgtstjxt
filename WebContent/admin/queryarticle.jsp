		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="4" cellspacing="1"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">新闻公告信息列表</td>
					</tr>
					<tr align="center">
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form action="article/queryArticleByCond.action" name="myform" method="post">
								查询条件<select name="cond" style="width: 100px"><option value="title">按标题查询</option>
									<option value="addtime">按发布日期查询</option>
									<option value="hits">按点击数查询</option></select>关键字<input type="text" name="name" style="width: 100px" /><input
