...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="books/addBooks.action" name="myform" method="post" onsubmit="return check()">
					<table width="40%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">添加图书</td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">图书名称</td>
							<td align="left"><input type="text" placeholder="请输入图书名称" name="booksname" style="width: 160px"
								id="booksname" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">图片</td>
							<td align="left"><input type="text" placeholder="请选择图片" name="image" style="width: 160px" id="image"
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" placeholder="请输入出版社" name="publisher" style="width: 160px"
								id="publisher" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">作者</td>
							<td align="left"><input type="text" placeholder="请输入作者" name="author" style="width: 160px" id="author" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">库存数</td>
							<td align="left"><input type="text" placeholder="请输入库存数" name="storage" style="width: 160px" id="storage" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">存放位置</td>
							<td align="left"><input type="text" placeholder="请输入存放位置" name="weizhi" style="width: 160px" id="weizhi" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">图书介绍</td>
							<td align="left"><script type="text/javascript" src="ckeditor/ckeditor.js"></script>
