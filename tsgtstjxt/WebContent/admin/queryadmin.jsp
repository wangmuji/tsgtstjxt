		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="4" cellspacing="1"
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form action="admin/queryAdminByCond.action" name="myform" method="post">
						...
						<option value="addtime">按创建日期查询</option></select>关键字<input type="text" name="name" style="width: 100px" /><input
