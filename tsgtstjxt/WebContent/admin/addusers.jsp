...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="users/addUsers.action" name="myform" method="post" onsubmit="return check()">
					<table width="40%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">添加读者用户</td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" placeholder="请输入出生日期" name="birthday" style="width: 160px" id="birthday"
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" placeholder="请输入联系地址" name="address" style="width: 160px" id="address" /></td>
						</tr>
