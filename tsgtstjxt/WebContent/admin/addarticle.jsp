...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="article/addArticle.action" name="myform" method="post"
					...
					<table width="40%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" placeholder="请输入标题" name="title" style="width: 160px" id="title" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
