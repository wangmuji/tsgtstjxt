...
%><body><!--毕设成品下载网址   codebag.cn-->
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><form action="article/updateArticle.action" name="myform" method="post"
					onsubmit="return check()">
					<table width="40%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">修改新闻公告<input type="hidden" name="articleid"
								value="${article.articleid}" /><input type="hidden" name="addtime" id="addtime" value="${article.addtime}" /><input
								type="hidden" name="hits" id="hits" value="${article.hits}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">标题</td>
							<td align="left"><input type="text" name="title" style="width: 160px" id="title" value="${article.title}" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">图片</td>
							<td align="left"><input type="text" name="image" style="width: 160px" id="image" value="${article.image}"
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><script type="text/javascript" src="ckeditor/ckeditor.js"></script> <textarea cols="80"
									name="contents" id="contents" rows="10">${article.contents}</textarea> <script type="text/javascript">
