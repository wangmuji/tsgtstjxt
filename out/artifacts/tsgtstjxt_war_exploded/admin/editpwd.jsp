...
%><body>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr valign="top">
			<td bgcolor="#FFFFFF"><!--毕设成品下载网址   codebag.cn-->
				<form action="admin/editpwd.action" name="myform" onsubmit="return check()">
					<table width="40%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><%=session.getAttribute("adminname")%> <input type="hidden" name="username"
								style="width: 160px" id="username" value="<%=session.getAttribute("adminname")%>" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">密码</td>
							<td align="left"><input type="password" name="password" style="width: 160px" id="password" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">新密码</td>
							<td align="left"><input type="password" name="newpassword" style="width: 160px" id="newpassword" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">
							<td width="20%" align="right">确认密码</td>
							<td align="left"><input type="password" name="repassword" style="width: 160px" id="repassword" /></td>
						</tr>
						<!--毕设成品下载网址   codebag.cn-->
