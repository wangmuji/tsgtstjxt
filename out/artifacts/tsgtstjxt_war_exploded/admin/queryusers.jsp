		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0" align="center" cellpadding="4" cellspacing="1"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">读者用户信息列表</td>
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form action="users/queryUsersByCond.action" name="myform" method="post">
								查询条件<select name="cond" style="width: 100px"><option value="username">按用户名查询</option>
									...
									<option value="regdate">按注册日期查询</option></select>关键字<input type="text" name="name" style="width: 100px" /><input
