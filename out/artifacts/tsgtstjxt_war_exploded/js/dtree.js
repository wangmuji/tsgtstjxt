...
function dTree(objName) {
	...
	this.icon = {root:"images/left/base.gif", folder:"images/left/folder.gif", folderOpen:"images/left/folderopen.gif", node:"images/left/page.gif", empty:"images/left/empty.gif", line:"images/left/line.gif", join:"images/left/join.gif", joinBottom:"images/left/joinbottom.gif", plus:"images/left/plus.gif", plusBottom:"images/left/plusbottom.gif", minus:"images/left/minus.gif", minusBottom:"images/left/minusbottom.gif", nlPlus:"images/left/nolines_plus.gif", quit:"images/left/quit.gif", nlMinus:"images/left/nolines_minus.gif"};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
dTree.prototype.indent = function (node, nodeId) {
	...
	if (this.root.id != node.pid) {
		...
		if (node._hc) {
			...
			str += "<img align=\"absmiddle\" border=\"0\" src=\"" + ((this.config.useLines) ? ((node._ls) ? this.icon.joinBottom : this.icon.join) : this.icon.empty) + "\" alt=\"\" />";
		}
	}
	return str;
};
